...
## Usage
- Each file contains a LeetCode-style `Solution` class with the required method signature.
- Compile and run individual files as needed (they are snippets intended for LeetCode submissions).
